...
export default function CaseStudyTemplate() {
  ...
  // Timeline state - templates in CASE STUDY order
  ...
  const handleRenderFinal = async () => {
    ...
    try {
      ...
      for (const template of readyTemplates) {
        ...
        // CASE STUDY ORDER: Map template ID to correct order based on position in templates array
        const templateOrderMap = {
          'intro': 1,
          'how-it-works': 2,  // Problem comes second in case study flow
          'announcement': 3,   // Feature comes third in case study flow
          'persona': 4,
          'demo': 5,
          'closing': 6
        };
      ...
      // Template order: 1=intro, 2=how-it-works, 3=announcement, 4=persona, 5=demo, 6=closing
      for (let i = 0; i < 6; i++) {
