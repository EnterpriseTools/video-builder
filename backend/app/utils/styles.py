...
class AnnouncementStyles:
    ...
    # Fonts (200% larger for video render - 1080p needs bigger text)
    TITLE_SIZE = 84                         # Title size (42px * 200% for video)
    DESCRIPTION_SIZE = 36                   # Description size (18px * 200% for video)
