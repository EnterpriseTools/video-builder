...
class AnnouncementStyles:
    ...
    # Fonts (400% larger for video render - 1080p needs much bigger text)
    TITLE_SIZE = 168                        # Title size (42px * 400% for video)
    DESCRIPTION_SIZE = 72                   # Description size (18px * 400% for video)
